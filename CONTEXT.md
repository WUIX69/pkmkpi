...
- **Sandboxed Viewer**: The Next.js viewer shell at `/templates/[slug]` embedding running template ports or static snapshots inside `<iframe sandbox="allow-scripts allow-forms allow-same-origin">` with interactive responsive viewport presets (`375px`, `768px`, `1024px`, `1440px`, `100%`).
