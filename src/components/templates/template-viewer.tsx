...
export function TemplateViewer({
  ...
  return (
    <div className="flex flex-col h-screen bg-neutral-950 text-neutral-100 overflow-hidden font-sans">
      {/* Top Toolbar */}
      <header className="h-14 border-b border-neutral-800 bg-neutral-900/90 backdrop-blur-md px-4 flex items-center justify-between z-20 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline-flex px-2 py-0.5 rounded text-[11px] font-mono bg-neutral-800 text-neutral-300 border border-neutral-700">
              {stack}
            </span>
            <span className="text-xs text-neutral-400 hidden md:inline">by {author}</span>
          </div>
        </div>
      ...
      <div className="bg-neutral-900 border-b border-neutral-800 px-4 py-1.5 text-xs text-neutral-400 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2 truncate">
          ...
          <span className="truncate" title={description}>
            {description} · <code className="text-neutral-200">{serverUrl}</code>
          </span>
        </div>
